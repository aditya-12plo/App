    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left info">
          <p align="center" color="white">{{Auth::user()->username}}</p>
        </div>
      </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/users#/"><i class="fa fa-circle-o text-red"></i><span>Dashboard</span> </a></li>
        <li><a href="/users#/user-order"><i class="fa fa-circle-o text-red"></i><span>Order</span> </a></li>
        <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>User</span> <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span></a>
		<ul class="treeview-menu">
            <li><a href="/users#/user-profile"><i class="fa fa-circle-o"></i><span>Profile</span></a></li>
            <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-circle-o"></i> Log Out</a></li>
